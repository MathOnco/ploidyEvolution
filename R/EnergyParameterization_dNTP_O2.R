...
setwd("~/Projects/PMO/HighPloidy_DoubleEdgedSword/results")
source("../code/MathModel/GrowOrGo_PloidyEnergyRobustness/R/Utils.R")
indir = "~/Projects/discussion/grantsAndAwards/Rita Allen 2019/Proposal/SelectionForces_GastricCLs/Results/"
...
F_SDURATION = "S-phase_duration_Params.xlsx"
F_CCDURATION = "Duration_PerCellCyclePhase_PerClone.txt"
F_PLOIDYPOLYE="Ploidy_PolyE_PerCellCyclePhase_PerClone.txt"
...
if(FLAG_SAMPLECOHORT == "Stomach Cell Lines"){
  ...
  # P+R GBM
  PATIENT = "P06269"
  cpc = read.table(paste0(PATIENT,"_ploidyPerClone.txt"), sep="\t", check.names = F, stringsAsFactors = F )
  colnames(cpc) = "ploidy"
