...
knitr::opts_knit$set(root.dir = "C:/Users/4473331/Documents/projects/ploidyEvolution-main/Julia/")
...
ff <- list.files()
fE <- ff[grepl("_Energy",ff)][2]
fc <- ff[grepl("_pdestates",ff)][4]

xE <- proc_spat(fE,"C:/Users/4473331/Documents/projects/ploidyEvolution-main/Julia/")
plot_spat(xE,"energy")

xc <- proc_spat(fc,"C:/Users/4473331/Documents/projects/ploidyEvolution-main/Julia/")
...
ff <- list.files()
fc <- ff[grepl("pdestates",ff)]
fc <- fc[21]
time <- as.numeric(strsplit(fc,split="_")[[1]][1])/10
